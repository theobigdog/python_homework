...
def commence_battle(player, dragon):
    ...
    if dragon.health == 0:
        ...
        if dragon.name == "The Ancient":
            ...
            next()
            print()
            print('As you lay in The Bubba\'s bed over the next few weeks, you cry yourself to sleep each night.')
            print('"I am such a greedy moron," you sob one morning.  These are your last thoughts as you suffocate on your own mucus.')
            next()
            print()
...
class Trogdor_The_Burninator: # Easy Mode
    ...
    def intro(self):
        ...
        next()
        print()
        print('The tunnel continues to widen into a large cavern.  Conveniently spaced fires dot the ground, allowing you to see into the far reaches.')
